      ...
      >
        ...
        className="flex-1">
          <p className="mb-7 max-w-4xl text-[16px] font-Ovo">
            ...
            skills in creating responsive and user-friendly interfaces,
            developing RESTful APIs, and implementing database management
            solutions. Eager to apply my knowledge to real-world projects, I am
            driven by a strong desire to learn and adapt to new technologies. I
            am committed to delivering high-quality solutions and continuously
            improving my technical expertise. Open to opportunities where I can
